...
public:
    ...
    Tutorial(const std::string &title, const std::string &presenter, const Duration &duration, const int &noLikes,
             const std::string &source, const int &noViews = 0);
    ...
    bool operator==(const Tutorial &t) const;
...
public:
    static Tutorial
    MakeTutorial(const std::string &title, const std::string &presenter, const std::string &m, const std::string &s,
                 const std::string &noLikes, const std::string &source, const std::string &noViews = "0");
};